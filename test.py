...
class DCM2NIIConverter:
    ...
    def convert_dicom_to_nii(self, file_dir):
        ...
        sitk.WriteImage(image, f'{self.output_dir}/{file_name}.nii.gz')

    def split_dwi_files(self, file_dir):
            ...
            for mri_sequence in mri_sequences:
                ...
                if 'DWI' in mri_sequence_dir:
                    ...
                    for dwi_file in dwi_files:
                        ...
                        self.convert_dicom_to_nii(dwi_file_dir)
                else:
                    self.convert_dicom_to_nii(mri_sequence_dir)
